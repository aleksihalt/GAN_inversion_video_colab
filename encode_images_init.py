...
from encoder.generator_model_init import Generator
...
def main():
    ...
    parser.add_argument('-it', '--iterations', default=1000, help='Number of optimization steps for each batch', type=int)
